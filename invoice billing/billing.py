...
while(True):
  ...
  while(True):
    ...
    option = input("Pick the desired option (\'n\' to exit) : ").strip()
    if option.lower() == "n":
      break
    ...
    if(option=='1'):
        ...
        with open("D:/invoice billing/"+crt_usr+"/"+crt_usr+"_prod.csv") as prod_files:
          ...
          for j in prods:
            if(ch_prod==j[0]):
              ...
              crt_prods.append(j)
              break
        ano = input("Choose another product : (y/n) ")
        if(ano.lower() == "y"):
          continue
        else:
          break
      ...
      sheet["J8"] = vehi_no
      sheet["A48"] = "Rupees : "+Words(round(amt))+" Only."
    ...
    if(option=='2'):
      ...
      while(True):
        new_part={} 
        new_part["Name"] = input("-> Enter party name : ")
        new_part["Add_line1"] = input("\n-> Enter add line 1 : ")
        new_part["Add_line2"] = input("\n-> Enter add line 2 : ")
        new_part["Add_line3"] = input("\n-> Enter add line 3 : ")
        new_part["State"] = input("\n-> Enter State : ")
        new_part["GSTIN"] = input("\n-> Enter GSTIN : ")
        new_part["CODE"] = input("\n-> Enter CODE no. : ")
        
        new_part["RC"] = input("\n Reverse charges (yes/no) : ")
        new_part["IGST"] = input("\n IGST applicable (y/n) : ")
        new_part["Supply"] = input("\n Enter place of supply : ")
    ...
    if(option=='3'):
      ...
      while(True):
        new_prod={}
        new_prod["Name"] = input("-> Enter product name : ")
        new_prod["SCN"] = input("\n-> Enter SCN code : ")
        new_prod["UOM"] = input("\n-> Enter UOM : ")
        new_prod["Price"] = input("\n-> Enter Price/"+new_prod["UOM"]+" : ")
        new_prod["GST"] = input("\n-> Enter Total % of GST : ")
    ...
    if(option=="4"):
      ...
      while(True):
        new_trans={}
        new_trans["Name"] = input("-> Enter new transport : ")
        ...
        cont = input("Add another transport? (y/n) ")
        if(cont.lower()=='n'):
          break
        elif(cont.lower()=='y'):
          sleep(1)
      ...
      while(True):
        ...
        for name in bills:
          if(name.split(".")[0]) == billno:
            ...
            break
        bquest = input("Edit another bill ? (y/n) ")
        if(bquest.lower() == 'n'):
          break
    ...
    if(option=="9"):
      ...
      while(True):
        ...
        bquest = input("Print another DC ? (y/n) ")
        if(bquest.lower() == 'n'):
          break
